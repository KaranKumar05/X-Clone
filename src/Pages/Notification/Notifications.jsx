    ...
    <div className="flex items-start justify-start gap-0 tablet:justify-center pl-0 mobile:pl-8 tablet:gap-4">
      ...
      <span className="w-[100%] mobile-landscape:w-[37rem]">
        <div className="w-100% tablet:[38rem] text-white border-r border-l border-gray-600 mb-20 mobile:mb-0">
          <header className="flex flex-col items-center border-b border-gray-600 mobile:sticky top-0 left-0 right-0 bottom-0 backdrop-blur-md bg-black/10 z-10">
            <span className="flex items-center justify-between w-[100%] font-medium">
              <div className=" w-100% flex items-center gap-4  px-4 py-3 text-center">
            ...
            <span className="flex justify-center w-[100%]">
              <span className="text-center hover:cursor-pointer hover:bg-white/10 w-1/3 py-4">
                All
              </span>
              <span className="text-center hover:cursor-pointer hover:bg-white/10 w-1/3 py-4">
                Verified
          ...
          <Notification
            className="invert"
            img={Logo}
            message="There was a login to your account @DsAlpha07 from a new device on Feb 02, 2024. Review it now."
          />
          ...
          <Notification
            img={Logo}
            message="There was a login to your account @DsAlpha07 from a new device on Jan 30, 2024. Review it now."
          />
          <Notification
            img={Logo}
            message="Thank you for creating a new X account! We're thrilled to welcome you aboard."
          />
          <Notification
            img={ProfilePic}
            name="DsAlpha07."
