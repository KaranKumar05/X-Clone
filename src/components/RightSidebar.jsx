...
import Suggestion from "./RightSidebar/Suggestion";
import Trends from "./RightSidebar/Trends";
...
function RightSidebar() {
  return (
    <div className="text-white w-[15rem] laptop:w-[19rem] laptop:[20rem] flex flex-col gap-4">
      ...
      <div className="w-[15rem] laptop:w-[19rem] bg-[#16181C] p-4 rounded-xl flex flex-col gap-2">
        <h1 className="text-xl font-bold">Subscribe to Premium</h1>
        <p>
          Subscribe to unlock new features and if eligible, receive a share of
          ads revenue
        </p>
        <button className="bg-blue-500 px-8 py-[.5rem] rounded-full font-bold self-start">
          Subscribe
        </button>
      </div>
      ...
      <div className="w-[15rem] laptop:w-[19rem] bg-[#16181C] p-4 rounded-xl flex flex-col gap-4">
        ...
        <Suggestion img={ProfilePic} name="Karan Kumar" username="@DsAlpha07" />
        <Suggestion
